...
6. **Validation** — Preview the migrated page locally and compare against the original
...
This plan requires **Execute mode** to proceed. The migration will be orchestrated using the site migration workflow, which coordinates page analysis, block mapping, import generation, and content import in sequence.
